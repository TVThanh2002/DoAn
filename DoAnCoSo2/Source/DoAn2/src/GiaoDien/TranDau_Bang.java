			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(checkTinhTrang.isSelected()) {
						...
						dbconnect.getStmt().execute("INSERT INTO TranDau VALUES('"+txtMaTran.getText()+"',N'"+doi1+"','"+txtBanThang1.getText()+"',N'"+doi2+"','"+txtBanThang2.getText()+"',N'"+tinhtrang+"',N'"+txtThoiGian.getText()+"','"+cbbSan.getSelectedItem().toString()+"',N'"+BangDau.tenBang+"',N'"+GiaiDau.maGiai+"')");
					}
					else {
						tinhtrang = "";
						modelTranDau.addRow(new String [] {txtMaTran.getText(),txtThoiGian.getText(),cbbSan.getSelectedItem().toString(),cbbDoi1.getSelectedItem().toString(),"",cbbDoi2.getSelectedItem().toString(),"",tinhtrang});	
						dbconnect.getStmt().execute("INSERT INTO TranDau VALUES('"+txtMaTran.getText()+"',N'"+doi1+"',"+null+",N'"+doi2+"',"+null+",N'"+tinhtrang+"',N'"+txtThoiGian.getText()+"','"+cbbSan.getSelectedItem().toString()+"',N'"+BangDau.tenBang+"',N'"+GiaiDau.maGiai+"')");
					}
					txtMaTran.setText("");
					txtThoiGian.setText("");
					txtBanThang1.setText("");
				...
				try {
					...
					if(checkTinhTrang.isSelected()) {
						dbconnect.getStmt().execute("UPDATE TranDau SET doi1=N'"+doi1+"',banthang1='"+txtBanThang1.getText()+
							"',doi2='"+doi2+"',banthang2='"+txtBanThang2.getText()+"',tinhtrang=N'Đã thi đấu',thoigian='"+txtThoiGian.getText()+"',san=N'"+cbbSan.getSelectedItem().toString()+"',BangDau=N'"+BangDau.tenBang+"' WHERE ID='"+modelTranDau.getValueAt(row, 0).toString()+"'");
						...
						dbconnect.getStmt().execute("UPDATE TranDau SET doi1=N'"+doi1+"',banthang1="+null+
								",doi2='"+doi2+"',banthang2="+null+",tinhtrang=N'',thoigian='"+txtThoiGian.getText()+"',san=N'"+cbbSan.getSelectedItem().toString()+"',BangDau=N'"+BangDau.tenBang+"' WHERE ID='"+modelTranDau.getValueAt(row, 0).toString()+"'");
