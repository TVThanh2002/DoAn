...
//char I2C_Start(char slave_write_address);                       /* send start pulse along with slave device address */
//void I2C_Start_Wait(char slave_write_address);                  /* send start pulse along with slave device address 
//                                             * and wait if not work */
//char I2C_Repeated_Start(char slave_read_address);              /* send repeated start pulse along with device write address*/
//char I2C_Stop();                            /* send stop pulse*/
//char I2C_Write(unsigned char data);              /* transmit/write data/address to slave device */
